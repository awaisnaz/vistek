...
process.env.APPDOMAIN = "http://13.40.237.152:8080";
...
app.use("/report", upload.array(), (req, res, next) => {
  ...
  if (req.dom.report.regno) {
    ...
    req.dom.report.counter++;
    if (req.dom.report.counter >= 4 && !req.body.basicsectionunregisteredorder && !req.body.fullsectionunregisteredorder) next();
  }
      ...
      <head>
        ...
        <script defer>
          ...
          window.addEventListener("load",()=>{
            ...
            if (!dom.report.basic.vehicleandmothistory.VehicleRegistration && !dom.report.basic.vehicleandmothistory.MotHistory.RecordList && !dom.report.basic.valuation) {
            ...
            if (dom.report.basic.vehicleandmothistory.VehicleRegistration) {
              window.document.querySelector(".basicregistrationvrm").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.Vrm;
              window.document.querySelector(".basicregistrationfirstregistered").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.DateFirstRegistered != null ? dom.report.basic.vehicleandmothistory.VehicleRegistration.DateFirstRegistered : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationfirstregistereduk").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.DateFirstRegisteredUk != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.DateFirstRegisteredUk : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationdatelastupdate").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.DateOfLastUpdate != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.DateOfLastUpdate : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationvehicleusedbeforeregistration").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.VehicleUsedBeforeFirstRegistration != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.VehicleUsedBeforeFirstRegistration : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationvehicleyearmonthfirstregistered").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.YearMonthFirstRegistered != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.YearMonthFirstRegistered : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationyearofmanufacture").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.YearOfManufacture != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.YearOfManufacture : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationmake").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.Make != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.Make : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationmakemodel").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.MakeModel != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.MakeModel : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationmodel").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.Model != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.Model : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationmvrismakecode").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.MvrisMakeCode != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.MvrisMakeCode : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationmvrismodelcode").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.MvrisModelCode != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.MvrisModelCode : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationvehicleclass").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.VehicleClass != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.VehicleClass : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationco2emissions").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.Co2Emissions != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.Co2Emissions : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationcolor").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.Colour != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.Colour : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationdoorplan").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.DoorPlan != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.DoorPlan : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationdoorplanliteral").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.DoorPlanLiteral != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.DoorPlanLiteral : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationenginecapacity").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.EngineCapacity != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.EngineCapacity : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationenginenumber").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.EngineNumber != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.EngineNumber : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationfueltype").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.FuelType != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.FuelType : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationmaxpermissiblemass").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.MaxPermissibleMass ? dom.report.basic.vehicleandmothistory.VehicleRegistration.MaxPermissibleMass : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationgearcount").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.GearCount != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.GearCount : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationgrossweight").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.GrossWeight != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.GrossWeight : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationseatingcapacity").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.SeatingCapacity != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.SeatingCapacity : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationtransmission").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.Transmission != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.Transmission : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationtransmissioncode").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.TransmissionCode != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.TransmissionCode : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationtransmissiontype").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.TransmissionType != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.TransmissionType : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationwheelplan").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.WheelPlan != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.WheelPlan : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationimported").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.Imported != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.Imported : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationimportnoneu").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.ImportNonEu != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.ImportNonEu : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationexported").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.Exported != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.Exported : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationdateexported").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.DateExported != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.DateExported : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationscrapped").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.Scrapped != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.Scrapped : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationdatescrapped").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.DateScrapped != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.DateScrapped : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationcertificateofdestructionissued").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.CertificateOfDestructionIssued != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.CertificateOfDestructionIssued : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationpreviousvrmgb").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.PreviousVrmGb != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.PreviousVrmGb : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationpreviousvrmni").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.PreviousVrmNi != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.PreviousVrmNi : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationvin").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.Vin != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.Vin : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationvinconfirmationflag").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.VinConfirmationFlag != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.VinConfirmationFlag : "NOT AVAILABLE";
              window.document.querySelector(".basicregistrationvinlast5").innerHTML = dom.report.basic.vehicleandmothistory.VehicleRegistration.VinLast5 != null? dom.report.basic.vehicleandmothistory.VehicleRegistration.VinLast5 : "NOT AVAILABLE";
            }
            ...
            if(dom.report.basic.valuation){
              ...
              window.document.querySelector(".otr").innerHTML = dom.report.basic.valuation.ValuationList.OTR ? "£ " + dom.report.basic.valuation.ValuationList.OTR.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : "NOT AVAILABLE";
              window.document.querySelector(".dealerforecourt").innerHTML = dom.report.basic.valuation.ValuationList.DealerForecourt ? "£ " + dom.report.basic.valuation.ValuationList.DealerForecourt.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : "NOT AVAILABLE";
              window.document.querySelector(".traderetail").innerHTML = dom.report.basic.valuation.ValuationList.TradeRetail ? "£ " + dom.report.basic.valuation.ValuationList.TradeRetail.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : "NOT AVAILABLE";
              window.document.querySelector(".privateclean").innerHTML = dom.report.basic.valuation.ValuationList.PrivateClean ? "£ " + dom.report.basic.valuation.ValuationList.PrivateClean.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : "NOT AVAILABLE";
              window.document.querySelector(".privateaverage").innerHTML = dom.report.basic.valuation.ValuationList.PrivateAverage ? "£ " + dom.report.basic.valuation.ValuationList.PrivateAverage.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : "NOT AVAILABLE";
              window.document.querySelector(".partexchange").innerHTML = dom.report.basic.valuation.ValuationList.PartExchange ? "£ " + dom.report.basic.valuation.ValuationList.PartExchange.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : "NOT AVAILABLE";
              window.document.querySelector(".auction").innerHTML = dom.report.basic.valuation.ValuationList.Auction ? "£ " + dom.report.basic.valuation.ValuationList.Auction.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : "NOT AVAILABLE";
              window.document.querySelector(".tradeaverage").innerHTML = dom.report.basic.valuation.ValuationList.TradeAverage ? "£ " + dom.report.basic.valuation.ValuationList.TradeAverage.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : "NOT AVAILABLE";
              window.document.querySelector(".tradepoor").innerHTML = dom.report.basic.valuation.ValuationList.TradePoor ? "£ " + dom.report.basic.valuation.ValuationList.TradePoor.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : "NOT AVAILABLE";
              window.document.querySelector(".vrm").innerHTML = dom.report.basic.valuation.Vrm ? dom.report.basic.valuation.Vrm : "NOT AVAILABLE";
              window.document.querySelector(".mileage").innerHTML = dom.report.basic.valuation.Mileage ? dom.report.basic.valuation.Mileage : "NOT AVAILABLE";
              window.document.querySelector(".plateyear").innerHTML = dom.report.basic.valuation.PlateYear ? dom.report.basic.valuation.PlateYear : "NOT AVAILABLE";
              window.document.querySelector(".valuationtime").innerHTML = dom.report.basic.valuation.ValuationTime ? dom.report.basic.valuation.ValuationTime : "NOT AVAILABLE";
              window.document.querySelector(".vehicledescription").innerHTML = dom.report.basic.valuation.VehicleDescription ? dom.report.basic.valuation.VehicleDescription : "NOT AVAILABLE";
              window.document.querySelector(".valuationbook").innerHTML = dom.report.basic.valuation.ValuationBook ? dom.report.basic.valuation.ValuationBook : "NOT AVAILABLE";
              window.document.querySelector(".extractnumber").innerHTML = dom.report.basic.valuation.ExtractNumber ? dom.report.basic.valuation.ExtractNumber : "NOT AVAILABLE";
            }
        ...
        <div style="display:grid;grid-template-rows:repeat(auto-fit,minmax(0,auto));">
          <div class="navbar reportprinthide">
            <div class="nav" style="display:none;justify-content:space-between;grid-template-columns:repeat(auto-fit,minmax(0,auto));margin:0;position:fixed;top:0;z-index:1;background:white;width:100%;">
              ...
              <div class="navmenu" style="display:grid;grid-template-columns:auto auto auto auto auto auto auto auto; align-self:center;margin-right:0.5rem;">
          ...
          <div class = "home" style="display:none;">
            ...
            <div class="services1" id="services" style="display:grid;justify-items:center;">
              <div class="homeservices1main1" style="display:grid;justify-items:center;width:96vw;margin:0.5em;margin:1rem 0;">
                <div class="homeservices1main2" style="display:grid;grid-template-rows: auto auto; justify-items:center;grid-gap:0.5rem;">
                  <div style="display:grid;justify-items:center;width:100%;">
                    <div style="display:grid;justify-items:center;grid-gap:0.5rem;background:#f9d441;font-size:2rem;font-weight:bold;padding:0.5rem;width:100%;">
                      Services
                    </div>
                  </div>
            ...
            <div class="details" style="display:grid;justify-items:center;justify-self:center;text-align:justify;border-bottom: 0.1rem solid grey;margin-top:1rem;" class="details">
              <div style="display:grid;grid-template-rows:repeat(auto-fit,minmax(0,auto));justify-items:center;grid-gap:2rem;margin:1rem 0;">
                ...
                <div>
                  If you buy a car that has an outstanding loan or finance agreement against it, then you are in danger of losing the vehicle, and the money you paid for it. This is a real risk when purchasing a second-hand vehicle, so using a car finance checker to look into its history is an important action to take.<br/><br/>
                ...
                <div>
                  ...
                  Be wary of any place offering a free Car Check though, as anywhere that claims to provide such a service will not be delivering the genuine article. Instead, use the reliable VIS Reports to be safe in the knowledge of your new vehicle's financial history.
                </div>
              </div>
            </div>
            <div class="homepackages packages" id="packages" style="display:grid;grid-template-rows:repeat(auto-fit,minmax(0,auto));grid-gap:15px;justify-items:center;justify-self:center;text-align:justify;margin-top:1rem;width:96vw;">
              ...
              <div class="homepackagesdetails" style="display:grid;grid-template-columns:repeat(4,minmax(0,auto));justify-items:stretch;align-items:stretch;grid-gap:0.1rem;color:white;">
                ...
                <div style="background:#2f2e2a;">
                  <div style="display:grid;justify-items:center;">
                    <input name="homeregno" type="submit" style="background-color:#f9d441; padding:0.5rem;font-weight:bold;border:0px;font-size:1rem;cursor:pointer;margin:0.5rem;" value="ORDER" onclick="
                      window.document.querySelector('.homebannerbgmessage').style.display = 'grid'; 
                      ...
                      window.document.querySelector('.homebannerbgmessage').style.fontWeight = 'bold'; 
                      window.document.querySelector('.homebannerbgmessage').style.fontSize = '2rem'; 
                      window.location.href='/?homebannerbgmessage=1#homeregno';
                    ">
                  </div>
                </div>
                <div style="background:#2f2e2a;">
            ...
            <div class="accountreset reset" style="display:none;grid-template-rows:repeat(auto-fit,minmax(0,auto));background:#d6d6d6;justify-self:center;padding:0.5rem;width:100%;">
              ...
              <div class="accountresetmain" style="display:grid;grid-template-rows:repeat(auto-fit,minmax(0,auto));justify-items:center;padding:0.5rem;grid-gap:1rem;">
                ...
                <div class="accountresetpassword" style="display:grid;justify-items:stretch;">
                  <input class="accountresetpasswordinput" form="accountreset" type="password" name="accountresetpassword" placeholder="New Password" pattern="^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[#?!@$%^&*-]).{8,}$" title="Minimum eight characters, at least one uppercase letter, one lowercase letter, one number and one special character #, ?, !, @, $, %, ^, &, *, -." required style="background-color:#c4c4c4;padding:1rem;border:0;outline:none;text-align: center;font-size:1rem;box-sizing:border-box;border-radius:2rem;">
                </div>
                <div class="accountresetsubmit" style="display:grid;justify-items:stretch;width:227px;">
                  <input form="accountreset" type="submit" value="Reset Password" style="background-color:#f9d441;padding:1rem;border:0;outline:none;text-align:center;font-size:1rem;width:100%;box-sizing:border-box;cursor:pointer;border-radius:2rem;font-weight:bold;" onclick="let pattern = /^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[#?!@$%^&*-]).{8,}$/; if(!pattern.test(document.querySelector('.accountresetpasswordinput').value)) {
                      window.document.querySelector('.accountresetmessage').style.display = 'grid';
                      window.document.querySelector('.accountresetmessage').innerHTML = 'Please re-enter password meeting the criteria: minimum eight characters, at least one uppercase letter, one lowercase letter, one number and one special character #, ?, !, @, $, %, ^, &, *, -.';
                      window.document.querySelector('.accountresetmessage').style.color = '#B00020';
                      window.document.querySelector('.accountresetmessage').style.fontSize = '1rem'; 
                      return false;
                    }">
                </div>
              </div>
            ...
            <div class="reportmain" style="display:grid;grid-template-rows:repeat(11, auto);grid-gap:0.5rem;">
              ...
              <div class="reportfull" style="display:grid;grid-gap: 0.5rem;">
                ...
                <div class="reportfullsummary" id="reportfullchecksummary" style="display:grid;grid-template-rows:auto auto;justify-self:center;width:100%;">
                  <div class="reportfullsummarytitle" style="background:#f9d441;color:black;padding:0.5rem;font-size:1.5rem;">
                    FULL CHECK SUMMARY
                  </div>
          ...
          <div class="contact" style="display:none;justify-items:center;grid-gap:0.5rem;">
            <div class="contactbackground" style="display:grid;justify-items:center;background-image:url('contactbackground.jpg');background-position:center;background-repeat:no-repeat;background-size:cover;font-weight:bold;font-size:4rem;text-align:center;width:100%;">
              <div class="contactbackgroundtitle">
                Contact Us
              </div>
              <div class="contactbackgroundtext" style="font-size:1rem;font-weight:normal;">
          ...
          <div class="about" style="display:none;">
            <div class="abouttitle" style="background-image:url('aboutbackground.jpg');background-size:cover;background-position:center center;background-size:cover;background-repeat:no-repeat;">
              <div class="abouttitletext" style="text-align:center;font-weight:bold;font-size:4rem;width:100%;margin-bottom:1rem;">
                About Us
              </div>
              <div style="text-align:center;width:100%;margin-bottom:1rem;">
                VIS introduced vehicle history checks. Over time, we have built a strong reputation for credibility and trust.
              </div>
              <div style="text-align:center;width:100%;">
                VIS Check is the largest provider of technology driven data solutions in the automotive market, combining industry and unique data sets to create innovative and powerful solutions through excellent customer service.
              </div>
            </div>
            <style>
              @media all and (min-width: 551px){
