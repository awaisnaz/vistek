...
app.use("/dashboard/balance", (req, res, next) => {
  ...
  if (req.body.dashboardbalanceaddbasic) {
    stripe.checkout.sessions.create({
      ...
      line_items: [
        {
          price_data: {
            ...
            product_data: {
              ...
              images: ['https://vistek.herokuapp.com/reportbasic.jpg'],
            },
            unit_amount: 249,
          },
          quantity: 1,
      ...
      mode: 'payment',
      success_url: 'https://vistek.herokuapp.com/dashboard/balance?dashboardbalancemessagebasic=1',
      cancel_url: 'https://vistek.herokuapp.com/dashboard/balance?dashboardbalancemessagecancel=1'
    })
      .then(resp => {
  ...
  if (req.body.dashboardbalanceaddfull) {
    stripe.checkout.sessions.create({
      ...
      line_items: [
        {
          price_data: {
            ...
            product_data: {
              ...
              images: ['https://vistek.herokuapp.com/reportfull.jpg'],
            },
            unit_amount: 799,
          },
          quantity: 1,
      ...
      mode: 'payment',
      success_url: 'https://vistek.herokuapp.com/dashboard/balance?dashboardbalancemessagefull=1',
      cancel_url: 'https://vistek.herokuapp.com/dashboard/balance?dashboardbalancemessagecancel=1'
    })
      .then(resp => {
        res.redirect(resp.url);
  ...
  if (req.body.dashboardbalanceaddmulti) {
    stripe.checkout.sessions.create({
      ...
      line_items: [
        {
          price_data: {
            ...
            product_data: {
              ...
              images: ['https://vistek.herokuapp.com/reportmulti.jpg'],
            },
            unit_amount: 1445,
          },
          quantity: 1,
      ...
      mode: 'payment',
      success_url: 'https://vistek.herokuapp.com/dashboard/balance?dashboardbalancemessagemulti=1',
      cancel_url: 'https://vistek.herokuapp.com/dashboard/balance?dashboardbalancemessagecancel=1'
    })
      .then(resp => {
        res.redirect(resp.url);
