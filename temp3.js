...
let html = `<!DOCTYPE html><html lang="en"><head>
        ...
        <script defer="">
          ...
          window.addEventListener("load",()=>{
            ...
            dom = {"account":{"login":{"active":"ACTIVE","last":1649074121434,"message":{"color":"#6200EE","text":null},"role":null,"status":null},"register":{"message":{"color":"#6200EE","text":null}},"reset":{"message":{"color":null,"text":null}}},"admin":{"id":null,"json":{},"message":"","root":null},"contact":{"message":{"color":null,"text":null}},"dashboard":{"balance":{"basic":0,"full":0,"message":{"color":null,"text":null},"transactions":{}},"profile":{"contact":"","email":"CIXOFAK975@WHWOW.COM","message":{"color":null,"text":null},"name":"CIXOFAK975@WHWOW.COM","password":"4c6b82fbdfcc80be5c7537fb3cc1c889"},"reports":{"add":{"message":{"color":"","text":null}},"balance":{"message":{"color":"","text":""}},"cars":{},"page":1,"search":{"message":{"color":"","text":null},"regno":null}}},"home":{"banner":{"bg":{"message":{"color":null,"text":""}}}},"page":"/report","report":{"dvla":{"co2Emissions":270,"colour":"WHITE","dateOfLastV5CIssued":"2021-12-08","engineCapacity":2720,"fuelType":"DIESEL","make":"LAND ROVER","markedForExport":false,"monthOfFirstRegistration":"2007-07","motExpiryDate":"2021-12-07","motStatus":"Not valid","registrationNumber":"EU07JUA","revenueWeight":3180,"taxDueDate":"2021-10-31","taxStatus":"Untaxed","typeApproval":"M1","wheelplan":"2 AXLE RIGID BODY","yearOfManufacture":2007},"full":null,"regno":"EU07JUA","valuation":null,"vehicleandmothistory":{"MotHistory":{"RecordList":null},"VehicleRegistration":null},"basic":null,"counter":4}};
            console.log({"dom": dom});
      ...
      <body>
        <div style="display:grid;grid-template-rows:repeat(auto-fit,minmax(0,auto));">
          ...
          <div class="home" style="display:none;">
            ...
            <div class="details" style="display:grid;justify-items:center;justify-self:center;text-align:justify;border-bottom: 0.1rem solid grey;margin-top:1rem;">
              ...
              <div class="homepackagesdetails" style="display:grid;grid-template-columns:repeat(4,minmax(0,auto));justify-items:stretch;align-items:stretch;grid-gap:0.1rem;color:white;">
                ...
                <div style="display:grid;background:#2f2e2a;padding:0.5rem;">
                  <div style="display:grid;justify-self:center;align-self:center;">
                    <img style="width:16px;height:16px;" src="/cross.png" alt="tick" loading="lazy">
                  </div>
                </div>
                <div style="display:grid;background:#2f2e2a;padding:0.5rem;">
                  <div style="display:grid;justify-self:center;align-self:center;">
                    <img style="width:16px;height:16px;" src="/tick.png" alt="tick" loading="lazy">
                  </div>
                </div>
                <div style="display:grid;background:#2f2e2a;padding:0.5rem;">
                  <div style="display:grid;justify-self:center;align-self:center;">
                ...
                <div style="display:grid;background:#2f2e2a;padding:0.5rem;">
                  <div style="display:grid;justify-self:center;align-self:center;">
                    <img style="width:16px;height:16px;" src="/cross.png" alt="cross" loading="lazy">
                  </div>
                </div>
                <div style="display:grid;background:#2f2e2a;padding:0.5rem;">
                  <div style="display:grid;justify-self:center;align-self:center;">
                ...
                <div style="display:grid;background:#2f2e2a;padding:0.5rem;">
                  <div style="display:grid;justify-self:center;align-self:center;">
                    <img style="width:16px;height:16px;" src="/cross.png" alt="tick">
                  </div>
                </div>
                <div style="display:grid;background:#2f2e2a;padding:0.5rem;">
                  <div style="display:grid;justify-self:center;align-self:center;">
              ...
              <div style="justify-self:start;align-self:start;margin:0.5rem;">
                <div style="display:grid;grid-template-rows: auto auto auto;grid-gap:5px;">
                  ...
                  <div style="font-size:90%;font-family: 'Roboto', sans-serif;justify-self:start;align-self:start;">
                    <img style="width:20px;height:20px;" src="/footerfacebook.png" alt="facebook icon" loading="lazy">
                  </div>
                  <div style="font-size:90%;font-family: 'Roboto', sans-serif;justify-self:start;align-self:start;">
                    <img style="width:20px;height:20px;" src="/footertwitter.png" alt="twitter icon" loading="lazy">
                  </div>
                  <div style="font-size:90%;font-family: 'Roboto', sans-serif;justify-self:start;align-self:start;">
                    <img style="width:20px;height:20px;" src="/footerinstagram.png" alt="instagram icon" loading="lazy">
                  </div>
                </div>
              </div>
            </div>
...
ReferenceError: document is not defined
    at file:///home/ec2-user/environment/server.js:5175:29
    at Layer.handle [as handle_request] (/home/ec2-user/environment/node_modules/express/lib/router/layer.js:95:5)
    at trim_prefix (/home/ec2-user/environment/node_modules/express/lib/router/index.js:317:13)
    at /home/ec2-user/environment/node_modules/express/lib/router/index.js:284:7
    at Function.process_params (/home/ec2-user/environment/node_modules/express/lib/router/index.js:335:12)
    at next (/home/ec2-user/environment/node_modules/express/lib/router/index.js:275:10)
    at Gun.<anonymous> (file:///home/ec2-user/environment/server.js:879:44)
    at Timeout._onTimeout (/home/ec2-user/environment/node_modules/gun/lib/open.js:22:12)
    at listOnTimeout (node:internal/timers:559:17)
    at processTimers (node:internal/timers:502:7)
^C
awaisnazir:~/environment (main) $ npm start
...
dom: {
  ...
  admin: { id: null, json: {}, message: '', root: null },
  contact: { message: { color: null, text: null } },
  dashboard: {
    balance: { basic: 0, full: 0, message: [Object], transactions: {} },
    profile: {
      contact: '',
      email: 'CIXOFAK975@WHWOW.COM',
      message: [Object],
      name: 'CIXOFAK975@WHWOW.COM',
      password: '4c6b82fbdfcc80be5c7537fb3cc1c889'
    },
    reports: {
      add: [Object],
      balance: [Object],
  ...
  report: {
    ...
    regno: null,
    valuation: null,
    vehicleandmothistory: { MotHistory: [Object], VehicleRegistration: null }
  }
}
--------------------------------
user: CIXOFAK975@WHWOW.COM
...
dom: {
  ...
  report: {
    dvla: {
      co2Emissions: 270,
      colour: 'WHITE',
      dateOfLastV5CIssued: '2021-12-08',
      engineCapacity: 2720,
      fuelType: 'DIESEL',
      make: 'LAND ROVER',
      markedForExport: false,
      monthOfFirstRegistration: '2007-07',
      motExpiryDate: '2021-12-07',
      motStatus: 'Not valid',
      registrationNumber: 'EU07JUA',
      revenueWeight: 3180,
      taxDueDate: '2021-10-31',
      taxStatus: 'Untaxed',
      typeApproval: 'M1',
...
pdf.create(html).toFile('./pdf3.pdf', function(err, res) {
